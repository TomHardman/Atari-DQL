...
from RL import DQLAgent, BasicDQN, ExperienceReplay, Transition, LossBuffer
...
def train_loop(i, u, env, criterion, optimizer, agent, replay: ExperienceReplay, dqn, target_dqn, loss_buffer, gamma=0.9,
        ...
        while True:
            ...
            s_prime = torch.Tensor(observation)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--episodes', type=float, default=1e6)
